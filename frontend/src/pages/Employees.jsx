...
zohoRole: editingEmployee.zohoRole || '', 
...
zohoRole: fullEmployee.zohoRole || '', 
...
<div> 
<label className="block text-sm font-semibold text-gray-700 mb-2">Zoho Role</label> 
<select 
value={formData.zohoRole} 
onChange={(e) => setFormData({ ...formData, zohoRole: e.target.value })} 
className="w-full px-4 py-2.5 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
> 
...
<div className="col-span-2"> 
<label className="block text-sm font-semibold text-gray-700 mb-2">Ask me about/Expertise</label> 
<input 
type="text" 
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4"> 
<div> 
<label className="block text-sm font-semibold text-gray-700 mb-2">UAN</label> 
<input 
type="text" 
value={formData.uan} 
...
<div className="col-span-2"> 
<label className="block text-sm font-semibold text-gray-700 mb-2">Seating Location</label> 
<input 
type="text" 
value={formData.seatingLocation} 
onChange={(e) => setFormData({ ...formData, seatingLocation: e.target.value })} 
className="w-full px-4 py-2.5 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
/> 
</div> 
<div className="col-span-2"> 
...
<h4 className="text-xl font-bold text-gray-800">Work Experience</h4> 
<button 
type="button" 
...
<div key={index} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4 mb-4 p-4 border border-gray-200 rounded-lg relative"> 
<button 
type="button" 
...
<div className="lg:col-span-1"> 
<label className="block text-sm font-semibold text-gray-700 mb-2">Relevant</label> 
<select 
value={experience.relevant} 
onChange={(e) => { 
const newExperiences = [...workExperiences] 
newExperiences[index].relevant = e.target.value === 'true' 
setWorkExperiences(newExperiences) 
}} 
className="w-full px-4 py-2.5 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
> 
...
onChange={(e) => { 
const newExperiences = [...workExperiences] 
newExperiences[index].jobDescription = e.target.value 
setWorkExperiences(newExperiences) 
}} 
rows="2" 
className="w-full px-4 py-2.5 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
...
<div className="bg-white rounded-xl shadow-sm p-5 border border-gray-200"> 
<div className="flex items-center justify-between mb-4"> 
<h4 className="text-xl font-bold text-gray-800">Education Details</h4> 
<button 
type="button" 
onClick={() => setEducationDetails([...educationDetails, { instituteName: '', degreeDiploma: '', specialization: '', dateOfCompletion: '' }]) 
} 
className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 flex items-center gap-1 text-sm" 
> 
<Plus size={16} /> Add Row 
...
<div key={index} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4 p-4 border border-gray-200 rounded-lg relative"> 
<button 
type="button" 
...
<div> 
<label className="block text-sm font-semibold text-gray-700 mb-2">Degree/Diploma</label> 
<input 
type="text" 
value={education.degreeDiploma} 
onChange={(e) => { 
const newEducation = [...educationDetails] 
newEducation[index].degreeDiploma = e.target.value 
setEducationDetails(newEducation) 
}} 
className="w-full px-4 py-2.5 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
/> 
...
<div> 
<label className="block text-sm font-semibold text-gray-700 mb-2">Date of Completion</label> 
<input 
type="date" 
value={education.dateOfCompletion} 
onChange={(e) => { 
const newEducation = [...educationDetails] 
newEducation[index].dateOfCompletion = e.target.value 
setEducationDetails(newEducation) 
}} 
className="w-full px-4 py-2.5 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
/> 
...
<div className="bg-white rounded-xl shadow-sm p-5 border border-gray-200"> 
<div className="flex items-center justify-between mb-4"> 
<h4 className="text-xl font-bold text-gray-800">Dependent Details</h4> 
<button 
type="button" 
onClick={() => setDependentDetails([...dependentDetails, { name: '', relationship: '', dateOfBirth: '' }]) 
} 
className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 flex items-center gap-1 text-sm" 
> 
<Plus size={16} /> Add Row 
...
<div key={index} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4 p-4 border border-gray-200 rounded-lg relative"> 
<button 
type="button" 
onClick={() => setDependentDetails(dependentDetails.filter((_, i) => i !== index)) 
} 
className="absolute top-2 right-2 text-red-600 hover:text-red-800" 
> 
<Trash2 size={18} /> 
...
onChange={(e) => { 
const newDependents = [...dependentDetails] 
newDependents[index].name = e.target.value 
setDependentDetails(newDependents) 
}} 
className="w-full px-4 py-2.5 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
/> 
</div> 
...
<div className="space-y-6"> 
	...
	<div className="bg-gray-50 rounded-xl p-6 border border-gray-200"> 
		...
		<div className="grid grid-cols-2 gap-4"> 
			...
			<div> 
				...
				<p className="text-base font-semibold text-gray-900">{selectedEmployee.nickName || 'N/A'}</p> 
			</div> 
			<div> 
	...
	<div className="bg-gray-50 rounded-xl p-6 border border-gray-200"> 
		...
		<div className="grid grid-cols-2 gap-4"> 
			...
			<div> 
				<p className="text-sm text-gray-600 mb-1">Zoho Role</p> 
				<p className="text-base font-semibold text-gray-900">{selectedEmployee.zohoRole || 'N/A'}</p> 
			</div> 
			<div> 
			...
			<div> 
				<p className="text-sm text-gray-600 mb-1">Date of Exit</p> 
				<p className="text-base font-semibold text-gray-900">{selectedEmployee.dateOfExit ? new Date(selectedEmployee.dateOfExit).toLocaleDateString() : 'N/A'}</p> 
			</div> 
			<div> 
			...
			<div> 
				...
				<p className="text-base font-semibold text-gray-900">{selectedEmployee.shiftId || 'N/A'}</p> 
			</div> 
		</div> 
	</div> 
{/* Action Buttons */} 
